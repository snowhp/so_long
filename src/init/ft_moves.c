...
/*   Updated: 2023/04/20 15:23:51 by tde-sous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_movedown(t_data *d)
{
	...
	if (d->map[d->p_y + 1][d->p_x] != '1')
	{
		mlx_put_image_to_window(d->mlx_ptr, d->mlx_win, d->fimg, d->p_x * SIZE, d->p_y * SIZE);
		d->p_y++;
		ft_printf("Moves: %i\n", ++d->moves);
		mlx_put_image_to_window(d->mlx_ptr, d->mlx_win, d->pimg, d->p_x * SIZE, d->p_y * SIZE);
	}
}
